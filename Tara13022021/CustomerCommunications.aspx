<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerCommunications.aspx.cs" Inherits="CustomerCommunications" %>
            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content" style="margin-top:20px">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="#" class="btn btn-primary btn-block margin-bottom">Customer Communication Table</a>
                               ...
                               <asp:GridView ID="GridView1" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="" HeaderText="Select">
                                            <ItemTemplate>


                                                <asp:CheckBox ID="btnchkbox"
                                                runat="server" CommandArgument='<%# Eval("Custno") %>'
                                                CausesValidation="False" OnCheckedChanged="btnchkbox_CheckedChanged" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Phone Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblphone" runat="server" Text='<%# Eval("ContactPhone") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" HorizontalAlign="Left" />
                                            <HeaderStyle Wrap="true" HorizontalAlign="Left" CssClass="grdhead" />
                                        </asp:TemplateField>
