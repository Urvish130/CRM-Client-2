<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerMaster.aspx.cs" Inherits="CustomerMaster" %>
            ...
            <div class="box box-primary">
                ...
                <div class="row" style="text-align: right">
                    ...
                    <div class="col-md-12 form-group" style="padding-top: 5px">
                        ...
                        <asp:LinkButton ID="btnDelete" runat="server" TabIndex="32" OnClick="btnDelete_Click" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                    </div>
                </div>
                <!-- /.row -->
        </section>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton3" OnClick="lbtndesignreset_Click"  runat="server" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
