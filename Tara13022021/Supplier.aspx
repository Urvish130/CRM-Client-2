            ...
            <div class="box box-primary">
                ...
                <div class="row" style="text-align: right">
                    ...
                    <div class="col-md-12 form-group" style="padding-top: 5px">
                        ...
                        <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" TabIndex="32" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                    </div>
                </div>
                <!-- /.row -->
        </section>
