<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateSupplier.aspx.cs" Inherits="UpdateSupplier" %>
            ...
            <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" ValidationGroup="cust" SetFocusOnError="true" ForeColor="Red"
                ...
                <div class="row" style="text-align: right">
                    ...
                    <div class="col-md-12 form-group" style="padding-top: 5px">
                        <asp:LinkButton ID="btnupdate" runat="server" TabIndex="30" ValidationGroup="cust" OnClick="btnupdate_Click" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
                        <asp:LinkButton ID="btndelete"  OnClick="btndelete_Click" runat="server" TabIndex="31" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Delete</asp:LinkButton>
                        <asp:LinkButton ID="btncancel" OnClick="btncancel_Click" runat="server" TabIndex="32" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Cancel</asp:LinkButton>
                    </div>
                </div>
                <!-- /.row -->
        </section>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtbtypename"
                                                            ...
                                                            CssClass="validate"></asp:RequiredFieldValidator>
                                                                                                         ...
                                                                                                         <asp:Label  class="control-label" ID="lblmsg1" runat="server" Text="     " Width="500px" ForeColor="Red"></asp:Label> 
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton5" OnClick="lbtndesignreset_Click"  runat="server" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtgroupname"
                                                            ...
                                                            CssClass="validate"></asp:RequiredFieldValidator>
                                                                                                         ...
                                                                                                         <asp:Label  class="control-label" ID="lblmsg2" runat="server" Text="     " Width="500px" ForeColor="Red"></asp:Label> 
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="lbtndesignreset_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                     ...
                                                     <asp:Label  class="control-label" ID="lblmsg3" runat="server" Text="     " Width="500px" ForeColor="Red"></asp:Label> 
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                     ...
                                                     <asp:Label  class="control-label" ID="lblmsg4" runat="server" Text="     " Width="500px" ForeColor="Red"></asp:Label> 
