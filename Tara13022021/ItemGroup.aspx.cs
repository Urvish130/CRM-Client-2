...
public partial class ItemGroup : System.Web.UI.Page
{
    ...
    public void bindDetail()
    {
        ...
        try
        {
            ...
            dt = bal.getallItemgroupforadminBAL();
            if (dt.Rows.Count > 0)
            {
    ...
    protected void grddata_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                DataTable dtdata = bal.getItemgroupdatabyidBAL(lblid.Text);
                if (dtdata.Rows.Count > 0)
                {
                    txtName.Text = dtdata.Rows[0]["ItemGroupName"].ToString();
                    txtName.Focus();
            ...
            else if (e.CommandName == "deletedata")
            {
                ...
                result = bal.deleteItemgroupdatabyidBAL(lblid.Text);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dt1 = bal.checkItemgroupnameBAL(txtName.Text);
            if (dt1.Rows.Count > 0)
            {
            ...
            else
            {
                ...
                bal.tblItemgroup_Master_InsertBAL(txtName.Text, lblloginid.Text, localTime, "", "", "", "", "");
                bindDetail();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            string result = bal.tbl_Itemgroup_UpdateBAL(lblid.Text, txtName.Text);
            if (result == "-1")
            {
