...
public partial class UpdateTerms : System.Web.UI.Page
{
    ...
    public void BindTerms(string id)
    {
        try
        {
            string result;
            ...
            DataTable dtdata = bll.gettermsandconditionsdatabyidBAL(id);
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            bll.tbl_termsandconditionsupdate(lblid.Text, txtName.Text, Txttandc.Text, txtSequence.Text);
            BindDetail();
            txtName.Text = "";
            Txttandc.Text = "";
            txtSequence.Text = "";
