<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerGroup.aspx.cs" Inherits="CustomerGroup" %>
            ...
            <div class="box box-primary">
                ...
                <div class="row" style="text-align: right">
                    ...
                    <div class="col-md-12 form-group" style="padding-top: 5px">
                        <asp:LinkButton ID="btnSave" runat="server" TabIndex="30" OnClick="btnSave_Click" ValidationGroup="custgroup" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
                        ...
                        <asp:LinkButton ID="btnDelete" OnClick="btnDelete_Click" runat="server" TabIndex="32" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                    </div>
                </div>
                <!-- /.row -->
        </section>
                    ...
                    <div class="modal">
                     ...
                     <asp:Label ID="lblmsg3" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="lbtndesignreset_Click"  TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
