                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                     ...
                     <asp:Label ID="lblmsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                            ...
                            <asp:LinkButton ID="btnUpdate" OnClick="btnUpdate_Click" Visible="false" runat="server" TabIndex="19" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
