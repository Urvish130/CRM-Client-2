<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ItemSubGroup.aspx.cs" Inherits="ItemSubGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Item SubGroup Master
                    
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                <li><a href="#">Master</a></li>
                <li class="active">Item SubGroup Master</li>
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                     ...
                     <asp:Label ID="lblmsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                            ...
                            <asp:LinkButton ID="btnDelete" runat="server" TabIndex="5" OnClick="btnReset_Click"  CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <asp:GridView ID="grddata" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                ...
                                <Columns>
                                     <asp:TemplateField HeaderText="Subgroup Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblItemsubGroupName" runat="server" Text='<%# Eval("ItemSubGroupName") %>'></asp:Label>
                                        </ItemTemplate>
