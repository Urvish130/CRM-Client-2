<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CopyQuotation.aspx.cs" Inherits="CopyQuotation" %>
...
<div class="box-body">
            ...
            <%--OnClick="btnaddproduct_Click"--%>                    <asp:LinkButton ID = "LinkButton16" runat="server" TabIndex="35" OnClick="btnaddTaxation_Click"  CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp; Add Taxation</asp:LinkButton>
                  <%-- OnClick= "lbtnupdatecontact_Click"--%>          
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group" style="padding-top: 5px; text-align: right">
                                <asp:LinkButton ID="btnUpdate" OnClick="btnSave_Click"  runat="server" TabIndex="37" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
