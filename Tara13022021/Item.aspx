                        ...
                        <div class="box-body">
                            ...
                            <div class="row" style="margin-top: 10px;">
                                 <div class="col-md-6 form-group">
                                    ...
                                    <asp:TextBox ID="txtImportDuty" CssClass="form-control" TabIndex="12" runat="server"></asp:TextBox>
                                </div>
                                  <div class="col-md-6 form-group" >
                                  
                                    <asp:TextBox ID="txtExportDuty" Visible ="false" CssClass="form-control" TabIndex="12" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group pull-right" style="text-align: right; margin-top: 5%">
                                    <asp:LinkButton ID="btnSave" OnClick="btnSave_Click" runat="server" TabIndex="16" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" runat="server"  OnClick="lbtndesignreset_Click" TabIndex="17" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="lbtnresetgroup" runat="server"  OnClick="lbtndesignreset_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton2" runat="server"  OnClick="lbtndesignreset_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
