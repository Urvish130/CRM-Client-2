<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateCompany.aspx.cs" Inherits="UpdateCompany" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Company Master
                     ...
                     <asp:Label ID="lblmsg5" runat="server" Text="" ForeColor="Red"></asp:Label>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="dpbusstype" InitialValue="0"
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" SetFocusOnError="true" ValidationGroup="comgroup" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="input-group">
                               ...
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="dpindustry" InitialValue="0"
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" SetFocusOnError="true" ValidationGroup="comgroup" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                                <span class="input-group-btn">
                   ...
                   <div class="row">
                        <div class="col-md-5 form-group">
                            <asp:GridView ID="gvImages" runat="server" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:ImageField DataImageUrlField="DocumentPath" HeaderText="Company Image" ControlStyle-Width="200px" ControlStyle-Height="150px"  />
                                </Columns>
                            </asp:GridView>
                       <hr />
                            <label>Upload Company Logo</label>
                            <asp:FileUpload runat="server" ID="fuCompanyImage" onchange="UploadFile(this);" />
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="fuCompanyImage" 
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" SetFocusOnError="true" ValidationGroup="comimg" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                            <asp:Button ID="Button4" OnClick="btnaddCompanyImage_Click" CssClass="btn btn-bitbucket btn-flat" ValidationGroup="comimg" Text="Add Company Logo" runat="server" CausesValidation="false" />
                       </div>
                        ...
                        <div class="col-md-7 form-group">
                            <asp:GridView ID="grdbanner" runat="server" AutoGenerateColumns="false">
                                ...
                                <Columns >
                                    <asp:ImageField DataImageUrlField="DocumentPath" ControlStyle-Width="600px"  ControlStyle-Height="150px" HeaderText="Company Banner"  />
                       ...
                       <hr />
                            <label>Upload Company Banner</label>
                            <asp:FileUpload runat="server" ID="FileUpload1" onchange="UploadFile(this);" />
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="FileUpload1" 
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" SetFocusOnError="true" ValidationGroup="combanner" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                            <asp:Button ID="btnaddbanner" OnClick="btnaddbanner_Click" CssClass="btn btn-bitbucket btn-flat" ValidationGroup="combanner" Text="Add Company Image" runat="server" CausesValidation="false" />
                        </div>
                    ...
                    <div class="row" style="text-align: right">
                        <div class="col-md-12 form-group" style="padding-top: 5px">
                           ...
                           <%-- <asp:LinkButton ID="btnUpdate" Visible="false" runat="server" TabIndex="31" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>--%>
                            <asp:LinkButton ID="btnDelete" runat="server" TabIndex="32" OnClick="lbtnresetcontact1_Click" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                        </div>
                    </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="lbtnreset_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="lbtnreset_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
