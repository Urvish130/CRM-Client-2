...
using System.Data;
using System.IO;
public partial class UpdatePrincipal : System.Web.UI.Page
{
    ...
    protected void lbtnuploadcatlogue_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (filecatelogue.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalCatlogue_Document_Master_InsertBAL(lblcomno.Text, txtcatloguename.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
    ...
    protected void lbtncreateapp_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (fileapp.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalApp_Document_Master_InsertBAL(lblcomno.Text, txtapp.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtapp.Text = "";
                bindapp();
                txtapp.Focus();
            }
    ...
    protected void lbtnaddpaper_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (filepaper.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalPaper_Document_Master_InsertBAL(lblcomno.Text, txtpaper.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtpaper.Text = "";
                bindpaper();
                txtpaper.Focus();
            }
    ...
    protected void lbtnaddnews_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Filenews.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalNews_Document_Master_InsertBAL(lblcomno.Text, txtnews.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtnews.Text = "";
                bindnews();
                txtnews.Focus();
            }
    ...
    protected void lbtnaddcerti_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Filecerti.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalCertificate_Document_Master_InsertBAL(lblcomno.Text, txtcertificate.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtcertificate.Text = "";
                bindcertificate();
    ...
    protected void lbtnaddppt_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Fileppt.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalPPT_Document_Master_InsertBAL(lblcomno.Text, txtppt.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtppt.Text = "";
                bindppt();
                txtppt.Focus();
            }
    ...
    protected void lbtnaddintroletter_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Fileintro.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalIntroLetter_Document_Master_InsertBAL(lblcomno.Text, txtintroletter.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
    ...
    protected void lbtnaddclientlist_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Fileclient.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalClient_Document_Master_InsertBAL(lblcomno.Text, txtclientlist.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtclientlist.Text = "";
                bindcient();
                txtclientlist.Focus();
            }
    ...
    protected void lbtncreateprogress_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FileProgress.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalProgress_Document_Master_InsertBAL(lblcomno.Text, txtprogress.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtprogress.Text = "";
                bindprogress();
                txtprogress.Focus();
            }
    ...
    protected void lbtnaddprice_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Fileprice.HasFile)
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalPrice_Document_Master_InsertBAL(lblcomno.Text, txtprice.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtprice.Text = "";
                bindprice();
                txtprice.Focus();
            }
    ...
    protected void lbtncreatecompatator_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Filecominfo.HasFile)
            {
                ...
                Filecominfo.SaveAs(Server.MapPath("~/Documents/") + fileName);
                string filepath = "~/Documents/" + fileName;
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalComInfo_Document_Master_InsertBAL(lblcomno.Text, txtcominfo.Text, fileName, filepath, lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtcominfo.Text = "";
                bindcominfor();
                txtcominfo.Focus();
            }
    ...
    protected void lbtnaddviedo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                TimeZoneInfo tzi = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                bal.tbl_PrincipalViedo_Master_InsertBAL(lblcomno.Text, txtviedotitle.Text, txtviedolink.Text, "", lblloginid.Text, localTime, "", "", "", "", ""); ShowMessage("Record Save!!!", MessageType.Success);
                txtviedotitle.Text = "";
                txtviedolink.Text = "";
                bindviedo();
                txtviedotitle.Focus();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bal.tbl_Principal_Master_UpdateBAL(lblcomno.Text,txtName.Text);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            bal.deletePrincipaldatabynoBAL(lblcomno.Text);
            Response.Redirect("PrincipalRegsiter.aspx", false);
        }
        catch (Exception ex)
        {
