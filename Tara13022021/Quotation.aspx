<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Quotation.aspx.cs" ValidateRequest="false" Inherits="Quotation" %>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="dpcustgroup"
                                Display="Dynamic" ErrorMessage="Please Select Customer Group" InitialValue="0" Text="(*) Required" ValidationGroup="Emst" SetFocusOnError="true" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="dpcust"
                                Display="Dynamic" ErrorMessage="Please Select Customer Name" Text="(*) Required" ValidationGroup="Emst" SetFocusOnError="true" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <asp:DropDownList ID="dpstatus" runat="server" Enabled="false" AutoPostBack="false" data-placeholder="Select Customer" CssClass="form-control select2" TabIndex="4"></asp:DropDownList>
                            <span class="input-group-btn">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="dpcontactper"
                                Display="Dynamic" ErrorMessage="Please Select Contact" Text="(*) Required" ValidationGroup="Emst" SetFocusOnError="true" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="dpsource"
             ...
             <%--   <div class="box-body">
                    <div class="box box-primary">
                        <div class="row" style="margin-top: 10px">--%>
                            ...
                            <%--<div class="col-md-2 form-group"> (Already commited)
                         ...
                         <%--   <div class="col-md-2 form-group">
                                <label>Select Currency Name<span class="required">* </span></label>
                            ...
                            <div class="col-md-1 form-group">
                                <label>Currency Value<span class="required">* </span></label>

                                <asp:TextBox ID="txtCurrencyValue" ReadOnly="true" Text="1" class="form-control" TabIndex="2" runat="server"></asp:TextBox>

                            </div>
                            <div class="col-md-1 form-group">
                                <label>INR Value<span class="required">* </span></label>

                                <asp:TextBox ID="txtINRvalue" placeholder="₹" class="form-control" TabIndex="2" runat="server"></asp:TextBox>
                            ...
                            <div class="col-md-2 form-group">
                                ...
                                <asp:TextBox ID="TextBox2" placeholder="Enter TAX Name" class="form-control" TabIndex="2" runat="server"></asp:TextBox>

                            </div>
                            <div class="col-md-2 form-group">
                                <label>TAX Percentage<span class="required">* </span></label>

                                <asp:TextBox ID="TextBox3"  placeholder="Enter TAX Percentage" class="form-control" TabIndex="2" runat="server"></asp:TextBox>
                ...
                <div class="box box-primary">
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <asp:DropDownList ID="dpfollowstatus" Enabled="false" runat="server" AutoPostBack="false" data-placeholder="Select Conatct Person" CssClass="form-control select2" TabIndex="5"></asp:DropDownList>
                            <span class="input-group-btn">
                    ...
                    <div class="box-body margin">
                        <div class="row">
                            ...
                            <div class="col-md-3 " style="align-content: center; font-size: 20px; padding-left: 60px">
                                ...
                                <label style="align-content: center">
                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="RefreshTermsdata" CssClass="btn btn-success btn-flat" CausesValidation="false"><i class="fa fa-refresh"></i></asp:LinkButton>
                                </label>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:GridView ID="grddata1" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                AutoGenerateColumns="False" BorderWidth="1px" ShowHeaderWhenEmpty="true" OnRowCommand="grdTerms_RowCommand"
                                CssClass="table table-striped table-bordered table-hover dataTable no-footer" CellPadding="2"
                                CellSpacing="2" EditRowStyle-HorizontalAlign="Center" PageSize="5" HeaderStyle-BackColor="#3c8dbc" HeaderStyle-ForeColor="White">
                                <AlternatingRowStyle BackColor="White" />
                                <PagerStyle CssClass="csspager" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Description" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lbltermsseries" runat="server" Text='<%# Eval("Extra1") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="true" HorizontalAlign="Left" />
                                        <HeaderStyle Wrap="true" HorizontalAlign="Left" CssClass="grdhead" />
                                    </asp:TemplateField>
                ...
                <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group" style="padding-top: 5px; text-align: right">
                            <asp:LinkButton ID="btnSave" OnClick="btnSave_Click" runat="server" ValidationGroup="Emst" TabIndex="36" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
