<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ClientCommunications.aspx.cs" Inherits="ClientCommunications" %>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div style="margin-left: 20px">
                                                    <i style="font-size: 20px">Add Attachments</i>
                                                </div>
                                        ...
                                        <div class="box-footer">
                                            <div class="pull-right">
                                                ...
                                                <asp:LinkButton ID="btnsend" class="btn btn-primary" runat="server"><i class="fa fa-envelope-o"></i> Send</asp:LinkButton>
                                            </div>
