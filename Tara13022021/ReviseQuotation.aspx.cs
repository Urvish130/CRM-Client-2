...
public partial class ReviseQuotation : System.Web.UI.Page
{
    ...
    protected void lbtnupdatefollowup_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bal.tbl_Quotation_Followup_updateBAL(Convert.ToInt32(lblid.Text), Convert.ToInt32(lblcomno.Text), txtfdate.Text, Convert.ToInt32(dpfollowuptype.SelectedValue.ToString()), Convert.ToInt32(dpassignto.SelectedValue.ToString()), Convert.ToInt32(dpfollowstatus.SelectedValue.ToString()), txtfremarks.Text, lblloginid.Text, localTime, "", "", "", "", "");
        ...
        try
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (inqno.Equals(""))
                    {
                        bal.tbl_Quotation_Master_InsertBAL(Convert.ToInt32(txtno.Text), Convert.ToInt32(lblcomno.Text), txtdate.Text, Convert.ToInt32(Groupid), Convert.ToInt32(custid), Convert.ToInt32(dpcontactper.SelectedValue.ToString()), txtcontactno.Text, Convert.ToInt32(ddlDept.SelectedValue.ToString()), Convert.ToInt32(ddldesign.SelectedValue.ToString()), txtemail.Text, txtmobileno.Text, txtmobileno2.Text, Convert.ToInt32(dpstatus.SelectedValue.ToString()), Convert.ToInt32(dpsource.SelectedValue.ToString()), txtremarks.Text, lblloginid.Text, localTime, "DirectQuotation", "", "", "", "");

                    }
                    else
                    {
                        bal.tbl_Quotation_Master_InsertBAL(Convert.ToInt32(txtno.Text), Convert.ToInt32(lblcomno.Text), txtdate.Text, Convert.ToInt32(Groupid), Convert.ToInt32(custid), Convert.ToInt32(dpcontactper.SelectedValue.ToString()), txtcontactno.Text, Convert.ToInt32(ddlDept.SelectedValue.ToString()), Convert.ToInt32(ddldesign.SelectedValue.ToString()), txtemail.Text, txtmobileno.Text, txtmobileno2.Text, Convert.ToInt32(dpstatus.SelectedValue.ToString()), Convert.ToInt32(dpsource.SelectedValue.ToString()), txtremarks.Text, lblloginid.Text, localTime, "InqtoQuotation", lblcomno.Text, "", "", "");
                    }
                }
                catch (Exception ex)
                {
