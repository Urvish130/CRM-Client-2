<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateDistributor.aspx.cs" Inherits="UpdateDistributor" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <asp:Label ID="lblbulkpassword" runat="server" Visible="false" Text=""></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ControlToValidate="txtbulkpassword" ValidationGroup="btnSave"
                                Display="Dynamic" ErrorMessage="Please Enter Password" Text="(*) Required" SetFocusOnError="true" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                       ...
                       <div class="row">
                        <div class="col-md-12 form-group" style="padding-top: 5px; text-align: right">
                            ...
                            <asp:LinkButton ID="btnUpdate" OnClick="btnSave_Click"  runat="server" TabIndex="37" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
                             <asp:LinkButton ID="btndeletee" OnClick="btndeleteee"  runat="server"  OnClientClick="return confirm('Do You Want to Delete?')"  TabIndex="41" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Delete</asp:LinkButton>
                            <asp:LinkButton ID="btnDelete" OnClick="btnDelete_Click" runat="server"  TabIndex="38" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Cancel</asp:LinkButton>
                        </div>
                    </div>
                    </div>
