                    ...
                    <div class="box box-primary">
                     ...
                     <asp:Label ID="lblmsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                            ...
                            <div class="form-group pull-right"> 
                                <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" TabIndex="19" CausesValidation="true" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
                            ...
                            <asp:GridView ID="grddata" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblname" runat="server" Text='<%# Eval("DesigName") %>'></asp:Label>
                                        </ItemTemplate>
