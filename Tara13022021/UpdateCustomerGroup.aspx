<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateCustomerGroup.aspx.cs" Inherits="UpdateCustomerGroup" %>
            ...
            <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" ValidationGroup="custgroup" SetFocusOnError="true" ForeColor="Red"
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtcontactname"
                                Display="Dynamic" ErrorMessage="Please Enter Name" Text="(*) Required" SetFocusOnError="true" ValidationGroup="custgroupcontact" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                ...
                <div class="row" style="text-align: right">
                    ...
                    <div class="col-md-12 form-group" style="padding-top: 5px">
                        <asp:LinkButton ID="btnupdate" runat="server" TabIndex="30" OnClick="btnupdate_Click" ValidationGroup="custgroup" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
                        <asp:LinkButton ID="btndelete" Visible="false" runat="server" OnClick="btndelete_Click" TabIndex="31" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Delete</asp:LinkButton>
                    ...
                    <div class="modal">
                     ...
                     <asp:Label ID="lblmsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="lbtndesignreset_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal">
                     ...
                     <asp:Label ID="lblmsg3" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton1" OnClick="lbtndesignreset_Click" runat="server"  TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
