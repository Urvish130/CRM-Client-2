...
public partial class AddCustContactWhileUpdate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                lblcomno.Text = Session["CustUpdateID"].ToString();
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            bal.tbl_Customer_Master_updateBAL(lblcomno.Text, dpcustgroup.SelectedValue.ToString(), txtName.Text, "", txtaddress.Text, txtcity.Text, txtstate.Text, txtdistrict.Text, txtcountry.Text, txtpincode.Text, txtphno.Text, txtemail.Text, Convert.ToInt32(dpbusstype.SelectedValue.ToString()), Convert.ToInt32(dpindustry.SelectedValue.ToString()), txturl.Text, rbtnstatus.SelectedItem.Text, txtgstno.Text, txtbankname.Text, txtaccno.Text, txtifsccode.Text, lblloginid.Text, localTime, "", "", "", "", "");
