...
public partial class Supplier : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt1 = new DataTable();
            dt1 = bal.checkSupplier_Master_nameBAL(txtName.Text);
            if (dt1.Rows.Count > 0)
            {
                mpbtype.Show();
            ...
            else
            {
                ...
                bal.tbl_Supplier_Master_InsertBAL(lblcomno.Text, txtName.Text, "", txtaddress.Text, txtcity.Text, txtstate.Text, txtdistrict.Text, txtcountry.Text, txtpincode.Text, txtphno.Text, txtemail.Text, Convert.ToInt32(dpbusstype.SelectedValue.ToString()), Convert.ToInt32(dpindustry.SelectedValue.ToString()), txturl.Text, rbtnstatus.SelectedItem.Text, txtgstno.Text, txtbankname.Text, txtaccno.Text, txtifsccode.Text, lblloginid.Text, localTime, "", "", "", "", "");
