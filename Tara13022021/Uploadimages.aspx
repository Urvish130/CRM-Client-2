<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Uploadimages.aspx.cs" Inherits="Uploadimages" %>
                    ...
                    <div class="box box-primary">
                     ...
                     <asp:FileUpload ID="FileUpload1" TabIndex="27" runat="server" />
                                ...
                                <div class="col-md-1 form-group" style="margin-top: 15px; margin-left: 180px; text-align: right">
                                 ...
                                 <%--   <asp:LinkButton ID="lbtnupload"  runat="server" TabIndex="35" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Upload</asp:LinkButton>--%>
                                     

                                </div>
                                  <div class="form-group pull-right" style="padding-right:20px; padding-top:20px" >
                                ...
                                <asp:LinkButton ID="btnDelete" OnClick="lbtndesignreset_Click"  runat="server" TabIndex="4" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                            </div>
                                </div>
                 </div>
                            ...
                            <asp:GridView ID="grddata" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Image Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblImageName" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Image Link">
                                        <ItemTemplate>
                                            <asp:Label ID="lblImagePath" runat="server" Text='<%# Eval("Path") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="true" HorizontalAlign="Left" />
                                        <HeaderStyle Wrap="true" HorizontalAlign="Left" CssClass="grdhead" />
                                    </asp:TemplateField>
